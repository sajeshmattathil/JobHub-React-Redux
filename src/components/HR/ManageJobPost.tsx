...
interface ManageJobPostProps {
  ...
  setManageJob: (value: React.SetStateAction<boolean>) => void;
}
...
const ManageJobPost: React.FC<ManageJobPostProps> = ({
  jobPostData,
  setManageJob,
}) => {
          ...
          {jobPostData && (
            ...
            <div
              ...
              style={{
                ...
                justifyContent: "center",
                alignContent: "center",
                maxHeight: "70vh", // Set a maximum height for scrolling
          overflowY: "auto", // Enable vertical scrolling
            ...
            >
              ...
              <div style={{ fontSize: "17px", marginBottom: "5px" }}>
                ...
                {jobPostData[0].experience ? `${jobPostData[0].experience}yrs` : 'Fresher'} 
              </div>
              <div style={{ fontSize: "17px", marginBottom: "5px" }}>
                <span>
                  <CiLocationOn />
